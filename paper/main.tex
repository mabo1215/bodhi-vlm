...
\begin{table}[t]
\centering
\caption{EMPA vs.\ baselines on VLM vision features (COCO, Laplace noise). Lower rMSE is better.}
\label{tab:vlmemparesults}
\begin{tabular}{l|cc|cc}
\hline
& \multicolumn{2}{c|}{CLIP ViT-B/32} & \multicolumn{2}{c}{LLaVA-1.5 7B} \\
Metric & $\epsilon{=}0.1$ & $\epsilon{=}0.01$ & $\epsilon{=}0.1$ & $\epsilon{=}0.01$ \\
\hline
Chi-square & 2.67 & 3.41 & 2.89 & 3.56 \\
K-L Div.   & 0.041 & 0.046 & 0.039 & 0.044 \\
MMD        & 3.12 & 4.02 & 3.34 & 4.21 \\
EMPA (Ours)& \textbf{1.89} & \textbf{2.34} & \textbf{2.11} & \textbf{2.67} \\
\hline
\end{tabular}
\end{table}
